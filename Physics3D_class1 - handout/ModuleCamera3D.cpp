...
update_status ModuleCamera3D::Update()
{
	...
	{
		App->camera->Move(vec3(0, 0.01f, 0));
		App->camera->LookAt(vec3(0, 0.01f,0));
	}
	...
	{
		App->camera->Move(vec3(0, 0, 0.01f));
		App->camera->LookAt(vec3(0, 0, 0.01f));
	}
	...
	{
		App->camera->Move(vec3(0.01f, 0, 0));
		App->camera->LookAt(vec3(0.01f, 0, 0));
	}
