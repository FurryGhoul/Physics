...
{
	const btVector3 pivotA(anchorA.x, anchorA.y, anchorA.z);
	const btVector3 pivotB(anchorB.x, anchorB.y, anchorB.z);

	btTypedConstraint* constraint = new btPoint2PointConstraint(*(bodyA.body), *(bodyB.body), pivotA, pivotB);
